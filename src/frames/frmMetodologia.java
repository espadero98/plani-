...
public class frmMetodologia extends javax.swing.JFrame {
    ...
    private DefaultTableModel modeloMetodologia;
    ...
    public void rellenoTabla(){
        String[] encabezadosTabla={"Código","Metodologia","Descripcion"};
        modeloMetodologia=new DefaultTableModel();
        ArrayList<Metodologia> meto = new ArrayList();
        Object[] fila = new Object[3];
        
        try {
            meto = ControladorMetodologia.Buscar();
            modeloMetodologia.setColumnIdentifiers(encabezadosTabla);
            Iterator<Metodologia> asig = meto.iterator();
            ...
            while (asig.hasNext()) {
                    ...
                    modeloMetodologia.addRow(fila);
                    tblMetodologia.setModel(modeloMetodologia);
                }
            
        } catch (ErrorPlanificacion ex) {
            Logger.getLogger(frmMetodologia.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void initComponents() {
        ...
        frmModificar.getContentPane().add(lblAgregar1, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 170, -1, -1));
        ...
        frmModificar.getContentPane().add(txtMetodologia, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 60, 180, -1));
        ...
        frmModificar.getContentPane().add(txtDescripcion, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 90, 180, -1));
        ...
        frmModificar.getContentPane().add(lblCancelar, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 180, -1, -1));
        ...
        tblMetodologia.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "Metodologia", "Descripcion"
            }
        ) {
        ...
        if (tblMetodologia.getColumnModel().getColumnCount() > 0) {
            tblMetodologia.getColumnModel().getColumn(0).setResizable(false);
            tblMetodologia.getColumnModel().getColumn(1).setResizable(false);
            tblMetodologia.getColumnModel().getColumn(2).setResizable(false);
        }
    ...
    private void lblAgregarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblAgregarMouseClicked
       frmMetodologiaAgregar add=new frmMetodologiaAgregar();
        add.setVisible(true);
    ...
    private void lblModificarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblModificarMouseClicked
        if(tblMetodologia.getSelectedRow()!=-1){
            ...
            seleccion = tblMetodologia.getSelectedRow();
            txtCodigo.setText(tblMetodologia.getValueAt(seleccion, 0).toString());
            txtMetodologia.setText((tblMetodologia.getValueAt(seleccion, 1).toString()));
            txtDescripcion.setText((tblMetodologia.getValueAt(seleccion, 2).toString()));
...
//            rellenoComboClasifiacion();
    ...
    private void lblEliminarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblEliminarMouseClicked
        ...
        if(tblMetodologia.getSelectedRow()!=-1){
            try {
                int seleccion;
                seleccion = tblMetodologia.getSelectedRow();
                meto.setIdMetodologia(tblMetodologia.getValueAt(seleccion, 0).toString());
                ControladorMetodologia.Eliminar(meto);
                JOptionPane.showMessageDialog(null, "La eliminacion fue correcta");
                modeloMetodologia.removeRow(tblMetodologia.getSelectedRow());
            } catch (ErrorPlanificacion ex) {
    ...
    private void lblAgregar1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblAgregar1MouseClicked
        ...
        if (codigo.isEmpty() && metodologia.isEmpty() && descripcion.isEmpty()) {
            JOptionPane.showMessageDialog(null, "Rellene todos los campos por favor");
        }else{
            try {
                Metodologia meto=new Metodologia();
                
                meto.setIdMetodologia(codigo);
                meto.setMetodologia(metodologia);
                meto.setDescripcion(descripcion);
                
                ControladorMetodologia.Modificar(meto);
